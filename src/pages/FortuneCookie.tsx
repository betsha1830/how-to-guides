      ...
      <div className="carousel flex">
        ...
        <div id="content-2" className="hidden content-2">
          <AdviceContent
            ...
            img_src="../assets/the_art_of_interpetation.svg"
        ...
        <div id="content-3" className="hidden content-3">
          <AdviceContent
            ...
            img_src="../assets/sharing_is_caring_or_a_trap.svg"
        ...
        <div id="content-4" className="hidden content-4">
          <AdviceContent
            ...
            img_src="../assets/luck_vs_real_life.svg"
        ...
        <div id="content-5" className="hidden content-5">
          <AdviceContent
            ...
            img_src="../assets/fortune_cookie.svg"
